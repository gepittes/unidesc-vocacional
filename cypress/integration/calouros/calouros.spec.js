...
export const test2E2 = () => {
    ...
    cy.get('input[name=nome]').type(obterValueAleatorio(15, false));
    cy.get('input[name=telefone]').type(obterValueAleatorio(11, true));
    cy.get('input[name=email]').type(`${obterValueAleatorio(15, false)}@gmail.com`);
