                ...
                <div class="row">
                    ...
                    <div class="col">
                        <div class="d-flex flex-row-reverse mt-lg-4">
                            <a href="{{route('home')}}"><button type="button" class="btn btn-info btn-rp-inicio">
                                    <strong><i class="fas fa-home"></i> Inicio</strong></button></a>
                        </div>
                    </div>
                </div><hr>
                ...
                <form action="{{route('recebe.form.cand')}}" METHOD="POST">
                        ...
                        <div class="form-row">
                            ...
                            <div class="form-group mt-3">
                                <button type="submit" class="btn btn-primary btn-rp-submit"><i class="fas fa-paper-plane"></i> Enviar</button>
                            </div>
                        </div>
                </form>
        </div>
